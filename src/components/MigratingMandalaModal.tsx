...
const MigratingMandalaModal = () => {
    ...
    const handleMigrate = async () => {
        ...
        try {
            ...
            const oldContractInstance = await Tezos.wallet.at(oldContractAddress);
                            ...
                            (<VStack spacing={4}>
                                ...
                                <RadioGroup onChange={val => setMigrateOption(val as string)} value={migrateOption}>
                                    <Stack direction="column">
                                        ...
                                        <Text size="xs" fontWeight="300" style={{ marginInlineStart: "1.5em" }}>
                                            Transfer your mandala to v2 without changes and with the same ID. This option is only available until May 31st, 15:00 UTC.</Text>
                                        <Text size="xs" fontWeight="300" style={{ marginInlineStart: "1.5em" }}>
